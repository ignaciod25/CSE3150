...
TEST_CASE("Testing prefix_sum function") {
    ...
    CHECK(prefix_sum(nums_3, sizeof(nums_3) / sizeof(nums_3[0]) - 1) == -1);
    CHECK(prefix_sum(nums_3, sizeof(nums_3) / sizeof(nums_3[0])) == 0);
    CHECK(prefix_sum(nums_4, sizeof(nums_4) / sizeof(nums_4[0])) == 15);
    CHECK(prefix_sum(nums_5, sizeof(nums_5) / sizeof(nums_5[0])) == -15);

    SUBCASE("non-negative sum") {
        CHECK(!non_negative_sum(nums_3, sizeof(nums_3) / sizeof(nums_3[0])));
        CHECK(non_negative_sum(nums_2, sizeof(nums_2) / sizeof(nums_2[0])));
        CHECK(non_negative_sum(nums_4, sizeof(nums_4) / sizeof(nums_4[0])));
    }

    SUBCASE("non-positive sum") {
        CHECK(non_positive_sum(nums_3, sizeof(nums_3) / sizeof(nums_3[0])));
        CHECK(!non_positive_sum(nums_2, sizeof(nums_2) / sizeof(nums_2[0])));
